  ...
  .controller('TourController', ['$scope', '$window', ($scope, $window) => {
    ...
    $scope.introJs.setOptions({
      ...
      },
      {
        ...
        intro: 'This shows how much time you have to choose an answer to the current question. After time out, CZAR then select a favorite answer. whoever submitted CZARs favorite answer wins the round.'
      },
      {
        element: '#the-czar',
      ...
      },
      {
        ...
        intro: 'You can click this icon to abandon a game at any time. I hope you never have to'
      },
      {
        element: '#home',
